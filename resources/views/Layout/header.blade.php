        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex justify-between items-center">
                ...
                <nav class="hidden md:flex items-center space-x-8">
                    <a href="/users" class="text-white hover:text-gray-300 py-2 active-nav-item">HOME</a>
                    <a href="/users" class="text-white hover:text-gray-300 py-2">USER</a>
                    <a href="/departments" class="text-white hover:text-gray-300 py-2">DEPARTMENT</a>
                ...
                <div x-data="{ open: false }" class="relative">
                    <button @click="open = !open" class="flex items-center text-white focus:outline-none">
                        ...
                        <img src="{{ Auth::user()->avatar ? asset('storage/' . Auth::user()->avatar) : 'https://kynguyenlamdep.com/wp-content/uploads/2022/06/avatar-cute-vui-nhon.jpg' }}" alt="Avatar" class="w-8 h-8 rounded-full">
                    </button>
            ...
            @else
                <a href="{{ route('login') }}" class="hidden md:block border-2 border-white text-white hover:bg-white hover:text-gray-900 px-6 py-2 rounded-md transition duration-300">
                    Sign In
                </a>
            @endif
                <!-- Mobile Menu Button -->
            ...
            <div id="mobile-menu" class="mobile-menu md:hidden flex flex-col mt-4 pb-4">
                ...
                <a href="/users" class="text-white hover:text-gray-300 py-2 px-4 border-b border-gray-700">USER</a>
                <a href="/departments" class="text-white hover:text-gray-300 py-2 px-4 border-b border-gray-700">DEPARTMENT</a>
