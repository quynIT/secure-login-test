...
<body>
    <header class="fixed top-0 left-0 w-full z-50 bg-opacity-70 backdrop-blur-md bg-gray-900">
        <div class="container mx-auto px-4 py-4">
            ...
            @endphp
<!-- Thêm icon giỏ hàng với badge số lượng -->
<a href="{{ route('cart.view') }}" class="relative">
    <svg xmlns="http://www.w3.org/2000/svg" class="h-9 w-9 bg-white rounded-3xl" fill="none" viewBox="0 0 24 24" stroke="currentColor">
